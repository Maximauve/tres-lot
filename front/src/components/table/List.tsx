          ...
          {items.map((item) => (
            <tr key={item["@id"]}>
              ...
              <td>
                <Links
                  items={{
                    href: `/kspaces/show/${encodeURIComponent(
                      item["workspace"]
                    )}`,
                    name: item["workspace"],
                  }}
              ...
              <td>
                <Link to={`/tables/show/${encodeURIComponent(item["@id"])}`}>
                  <span className="fa fa-search" aria-hidden="true" />
                  <span className="sr-only">Show</span>
                </Link>
              </td>
              <td>
                <Link to={`/tables/edit/${encodeURIComponent(item["@id"])}`}>
...
const List = () => {
  ...
  const id = (page && decodeURIComponent(page)) || "les";
